...
export const projectNavGroups = [
  ...
  { title: '收入测算', items: [['收入汇总', 'revenue-summary', 'done'], ['销售收入测算', 'revenue', 'done'], ['商业收入测算', 'commercial-revenue', 'done'], ['车位收入测算', 'parking-revenue', 'done'], ['其他收入测算', 'other-revenue', 'done'], ['去化节奏测算', '', 'planned']] },
  ...
  { title: '导入与配置', items: [['Excel导入导出', 'export', 'done'], ['导入批次', 'import-batches', 'done'], ['导入科目映射', 'cost-mapping', 'done'], ['系统自检', 'check', 'done'], ['模板中心', '/templates', 'done'], ['统一数据导入中心', '', 'planned'], ['下拉字典维护', '', 'planned'], ['AI测算助手', '', 'planned']] }
] as const;
