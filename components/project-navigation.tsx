...
export const projectNavGroups = [
  ...
  { title: '成本测算', items: [['目标成本编制', 'costs-batch', 'done'], ['目标成本汇总', 'summary', 'done'], ['土地费', 'land', 'done'], ['前期费', 'pre-costs', 'done'], ['土建明细', 'building-details', 'done'], ['安装明细', 'installation-details', 'done'], ['设备明细', 'equipment-details', 'done'], ['精装修明细', 'fitout-details', 'done'], ['室外管网', 'outdoor-pipe-details', 'done'], ['景观工程', 'landscape-details', 'done'], ['道路总平', 'road-details', 'done'], ['围墙出入口', 'wall-gate-details', 'done'], ['销售费用', 'sales-expense-details', 'done'], ['管理费用', 'admin-expense-details', 'done'], ['财务费用', 'finance-expense-details', 'done'], ['税金明细', 'tax-details', 'done'], ['土地增值税', 'land-vat', 'done'], ['税务报告', 'tax-report', 'done'], ['业态利润', 'profit-analysis', 'done'], ['汇总校验', 'summary-check', 'done'], ['所得税成本对象', '', 'planned'], ['土增税清算模拟', '', 'planned'], ['税费风险清单', '', 'planned']] },
