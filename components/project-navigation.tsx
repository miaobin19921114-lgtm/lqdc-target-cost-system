...
export const projectNavGroups = [
  ...
  { title: '项目基础', items: [['项目概况', 'overview', 'done'], ['业态维护/税务清算对象', 'product-maintenance', 'done'], ['测算版本控制中心', 'versions', 'done'], ['指标校验中心', 'indicator-check', 'done'], ['产品强排指标库', '', 'planned'], ['地块边界/红线资料', '', 'planned']] },
  ...
  { title: '税费利润', items: [['税费测算总表', 'tax-details', 'done'], ['土地增值税清算测算表', 'land-vat', 'done'], ['业态利润分析', 'profit-analysis', 'done'], ['税费风险清单', '', 'planned'], ['所得税成本对象复核', '', 'planned'], ['土增税清算资料清单', '', 'planned']] },
  { title: '导入与自检', items: [['Excel导入导出', 'export', 'done'], ['导入批次', 'import-batches', 'done'], ['导入科目映射', 'cost-mapping', 'done'], ['项目自检', 'check', 'done'], ['汇总校验', 'summary-check', 'done'], ['统一数据导入中心', '', 'planned'], ['导入异常清单', '', 'planned']] },
  { title: '模板与规则', items: [['模板中心/系统模板规则', '/templates', 'done'], ['项目规则沉淀', '', 'planned'], ['下拉字典维护', '', 'planned'], ['地区成本指标库', '', 'planned'], ['业态成本参数库', '', 'planned']] },
