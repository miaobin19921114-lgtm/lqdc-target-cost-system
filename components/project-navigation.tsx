...
export const projectNavGroups = [
  ...
  { title: '导入与自检', items: [['Excel导入/导出', 'export', 'done'], ['导入批次', 'import-batches', 'done'], ['科目映射', 'cost-mapping', 'done'], ['项目自检', 'check', 'done'], ['汇总校验', 'summary-check', 'done'], ['统一数据导入中心', '', 'planned'], ['导入异常清单', '', 'planned']] },
  { title: '模板与规则', items: [['模板中心/规则管理', '/templates', 'done'], ['项目规则沉淀', '', 'planned'], ['下拉字典维护', '', 'planned'], ['地区成本指标库', '', 'planned'], ['业态成本参数库', '', 'planned']] },
