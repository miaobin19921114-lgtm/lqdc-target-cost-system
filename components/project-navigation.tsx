...
export const projectNavGroups = [
  ...
  { title: '导入与配置', items: [['Excel导入导出', 'export', 'done'], ['导入批次', 'import-batches', 'done'], ['导入科目映射', 'cost-mapping', 'done'], ['系统校验', 'check', 'done'], ['模板中心', '/templates', 'done'], ['统一数据导入中心', '', 'planned'], ['下拉字典维护', '', 'planned'], ['AI测算助手', '', 'planned']] }
] as const;
