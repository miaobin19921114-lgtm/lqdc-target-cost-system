...
export const projectNavGroups = [
  ...
  { title: '项目基础', items: [['项目概况', 'overview', 'done'], ['测算版本控制中心', 'versions', 'done'], ['指标校验中心', 'indicator-check', 'done']] },
  ...
  { title: '成本测算', items: [['目标成本编制', 'costs-batch', 'done'], ['目标成本汇总', 'summary', 'done'], ['土地费', 'land', 'done'], ['前期费', 'pre-costs', 'done'], ['土建明细', 'building-details', 'done'], ['安装明细', 'installation-details', 'done'], ['设备明细', 'equipment-details', 'done'], ['精装修明细', 'fitout-details', 'done'], ['室外管网', 'outdoor-pipe-details', 'done'], ['景观工程', 'landscape-details', 'done'], ['道路总平', 'road-details', 'done'], ['围墙出入口', 'wall-gate-details', 'done'], ['销售费用', 'sales-expense-details', 'done'], ['管理费用', 'admin-expense-details', 'done'], ['财务费用', 'finance-expense-details', 'done'], ['分摊规则配置', 'allocation-rules', 'done'], ['成本分摊', 'cost-allocation', 'done'], ['税金明细', 'tax-details', 'done'], ['土地增值税', 'land-vat', 'done'], ['税务报告', 'tax-report', 'done'], ['业态利润', 'profit-analysis', 'done'], ['汇总校验', 'summary-check', 'done'], ['所得税成本对象', '', 'planned'], ['土增税清算模拟', '', 'planned'], ['税费风险清单', '', 'planned']] },
  ...
  { title: '导入与配置', items: [['Excel导入导出', 'export', 'done'], ['导入批次', 'import-batches', 'done'], ['导入科目映射', 'cost-mapping', 'done'], ['项目自检', 'check', 'done'], ['系统健康检查', '/health', 'done'], ['模板中心', '/templates', 'done'], ['统一数据导入中心', '', 'planned'], ['下拉字典维护', '', 'planned'], ['AI测算助手', '', 'planned']] }
] as const;
