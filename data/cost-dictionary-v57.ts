...
function buildRows(): CostDictionaryPresetRow[] {
  ...
  addDetail('03', '03.01', '建安工程费', '土建工程', '桩基及基础工程', [
    { name: '高层试桩工程', measureBasis: '高层住宅基底面积', unit: '根', applicableProductType: '高层住宅/住宅', remark: '工程量=高层基底面积×试桩含量；含量/系数可按项目地勘和桩型调整。' },
    { name: '高层工程桩', measureBasis: '高层住宅基底面积', unit: 'm', applicableProductType: '高层住宅/住宅', remark: '工程量=高层基底面积×桩长含量；用于管桩、灌注桩等工程桩测算。' },
    { name: '高层截桩头', measureBasis: '高层住宅基底面积', unit: '个', applicableProductType: '高层住宅/住宅', remark: '工程量=高层基底面积×截桩头含量。' },
    { name: '高层桩基检测', measureBasis: '高层住宅基底面积', unit: '点', applicableProductType: '高层住宅/住宅', remark: '工程量=高层基底面积×检测点含量；可按低应变、静载、声测等检测方案调整。' },
    { name: '高层基础垫层', measureBasis: '高层住宅基底面积', unit: '㎡', applicableProductType: '高层住宅/住宅', remark: '工程量=高层基底面积×垫层面积系数。' },
    { name: '高层承台/筏板基础', measureBasis: '高层住宅基底面积', unit: 'm³', applicableProductType: '高层住宅/住宅', remark: '工程量=高层基底面积×混凝土含量；按承台、筏板、基础梁方案调整。' }
  ], 6, '土建明细表', '基底面积×含量/系数', '按明细单位', '9%', '高层住宅/住宅', '03.01');
