...
const rows: RowInput[] = [
  ...
  },
  {
    ...
    product: '项目整体共用',
    remark: '按土地合同金额×费率测算。',
    targetCode: '01.02.01.02',
    targetSubject: '土地合同印花税'
  },
  {
    code: '01.03.01.01',
    parent: '01.03.01',
    ...
    third: '交易服务及尽调',
    detail: '土地交易服务费',
    measureBasis: '固定金额/合同金额',
    unit: '元/项',
    tax: '6%',
    product: '项目整体共用',
    remark: '服务类费用，有专票时按税率拆分不含税金额及可抵扣税额。',
    targetCode: '01.03.01.01',
  ...
  },
  {
    ...
    tax: '6%',
    product: '项目整体共用',
    remark: '需合同、发票、服务成果和付款证据完整。',
    targetCode: '01.03.01.03',
