...
const rows: RowInput[] = [
  {
    ...
    third: '土地价款',
    detail: '土地出让金',
    measureBasis: '用地面积（亩）/成交单价/固定金额',
    unit: '万元/亩',
    tax: '0%',
    product: '项目整体共用',
    remark: '按土地面积×万元/亩或合同金额测算。',
    targetCode: '01.01.01.01',
    targetSubject: '土地价款'
  },
  {
    code: '01.01.01.02',
  ...
  },
  {
    ...
    third: '土地价款',
    detail: '土地价款补缴',
    measureBasis: '补缴通知金额/固定金额',
    unit: '元/项',
    tax: '0%',
    product: '项目整体共用',
    remark: '对应V60补缴地价/补价款。',
    targetCode: '01.01.01.02',
    targetSubject: '补缴地价/补价款'
  },
  {
    code: '01.01.01.04',
    parent: '01.01.01',
    ...
    tax: '0%',
    product: '项目整体共用',
    remark: '按拆迁补偿协议、安置补偿协议和付款凭证复核。',
    targetCode: '01.01.01.03',
    targetSubject: '拆迁补偿及安置补偿'
  },
  {
    code: '01.01.01.05',
    parent: '01.01.01',
    ...
    tax: '0%',
    product: '项目整体共用',
    remark: '按补偿协议、确认单和付款凭证复核。',
    targetCode: '01.01.01.04',
    targetSubject: '青苗及地上附着物补偿'
  },
  {
    code: '01.01.01.06',
    parent: '01.01.01',
    ...
    tax: '0%',
    product: '项目整体共用',
    remark: '按你的口径保留，实质对应土地取得条件中的配建、移交、折抵。',
    targetCode: '01.01.01.01',
    targetSubject: '土地价款'
  },
  {
    ...
    third: '土地价款',
    detail: '合作开发土地投入',
    measureBasis: '合作协议金额/固定金额',
    unit: '元/项',
    tax: '0%',
    product: '项目整体共用',
    remark: '按你的口径保留，适用于合作开发、代垫土地款、股权合作形成的土地投入。',
    targetCode: '01.01.01.01',
    targetSubject: '土地价款'
  },
  {
    ...
    tax: '0%',
    product: '项目整体共用',
    remark: '按土地价款×费率测算；默认不拆可抵扣进项税。',
    targetCode: '01.01.02.01',
    targetSubject: '契税'
  },
  {
    code: '01.01.03.01',
    ...
    tax: '6%',
    product: '项目整体共用',
    remark: '服务类费用，有专票时按税率拆分不含税金额及可抵扣税额。',
    targetCode: '01.01.03.01',
    targetSubject: '土地交易服务费'
  },
  {
    code: '01.01.04.01',
    parent: '01.01.04',
  ...
  },
  {
    ...
    tax: '6%',
    product: '项目整体共用',
    remark: '按你的口径合并咨询与居间，需合同、发票、服务成果和付款证据完整。',
    targetCode: '01.01.05.01',
    targetSubject: '土地咨询/居间服务费'
  },
  {
    code: '01.01.06.01',
    parent: '01.01.06',
    ...
    tax: '6%',
    product: '项目整体共用',
    remark: '服务类费用，有专票时按税率拆分。',
    targetCode: '01.01.06.01',
    targetSubject: '土地尽调费'
  },
  {
    code: '01.01.07.01',
    ...
    tax: '6%',
    product: '项目整体共用',
    remark: '土地取得相关法务尽调，不归管理费用。',
    targetCode: '01.01.07.01',
    targetSubject: '法务尽调费'
  },
  {
    code: '01.01.08.01',
    ...
    tax: '6%',
    product: '项目整体共用',
    remark: '土地取得相关财税尽调，不归管理费用。',
    targetCode: '01.01.08.01',
    targetSubject: '财税尽调费'
  }
];
...
export function buildV60LandRows(offset: number): CostDictionaryPresetRow[] {
  return rows.map((row, index) => ({
    ...
    subjectDefinition: `${row.detail}，来源于V60土地费用明细表，用于目标成本明细测算。`,
