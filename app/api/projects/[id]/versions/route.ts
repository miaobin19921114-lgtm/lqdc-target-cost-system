  ...
  for (const product of source.products) {
    const created = await prisma.productType.create({
      data: {
        ...
        aboveGroundArea: product.aboveGroundArea,
        undergroundArea: product.undergroundArea,
        saleableArea: product.saleableArea,
        capacityArea: product.capacityArea,
        nonSaleableArea: product.nonSaleableArea,
        baseArea: product.baseArea,
        householdCount: product.householdCount,
        unitCount: product.unitCount,
        buildingCount: product.buildingCount,
        parkingCount: product.parkingCount,
