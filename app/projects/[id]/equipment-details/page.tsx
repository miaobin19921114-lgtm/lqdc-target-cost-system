      ...
      <div className="container" style={{ maxWidth: 1360 }}>
        <div className="page-header">
          <div>
            ...
            <p className="subtitle">设备科目、末级明细、适用业态、默认税率和分摊口径均从成本科目词典带出。</p>
          </div>
        ...
        <section className="form-card" style={{ maxWidth: '100%', marginBottom: 18 }}>
          <h2>新增设备工程</h2>
          <p className="meta">选科目后自动带出默认值。充电桩设备只记录快充、慢充、控制箱及设备本体；管线和安装调试进入安装明细表。</p>
        ...
        <section className="card">
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', minWidth: 1380, borderCollapse: 'collapse', fontSize: 13 }}>
              ...
              <tbody>
                {costs.length === 0 ? <tr><td colSpan={13} style={{ padding: 12, color: 'var(--muted)' }}>暂无设备明细。</td></tr> : costs.map((row) => (
                  <tr key={row.id}>
