...
export default async function DashboardLite({ params }: { params: { id: string } }) {
  ...
  const checks = [
    ...
    { name: '业态清算对象', ok: true, text: '可在业态维护中检查 7 类土增税清算对象', href: 'product-maintenance' },
    ...
    { name: '税费链路', ok: true, text: '税费总表、土增税清算、业态利润已接入', href: 'tax-details' },
