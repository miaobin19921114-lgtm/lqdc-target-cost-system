    ...
    <main style={{ minHeight: '100vh', background: '#eef3f8', color: '#102033' }}>
      ...
      <div className="sys-shell" style={{ display: 'grid', gridTemplateColumns: '260px 1fr 300px', gap: 12, padding: 12 }}>
        ...
        <section style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ background: '#fff', border: '1px dashed #d0d5dd', borderRadius: 10, padding: 14 }}><b style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>后续版本能力<PlannedBadge /></b><p className="meta">该功能不属于 V1.0.0 范围，后续版本再开放。</p></div>
        </section>
