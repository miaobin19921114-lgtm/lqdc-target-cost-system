...
export default async function ProjectMeasureCenter({ params, searchParams }: { params: { id: string }, searchParams?: Record<string, string | undefined> }) {
  ...
  const flow = [
    ...
    ['8 投决报告', 'decision', '输出经营总控、投决评审、经营报告和打印版报告', 'done'],
