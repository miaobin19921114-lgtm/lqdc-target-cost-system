...
export default async function SalesSchedulePage({ params, searchParams }: { params: { id: string }, searchParams?: { saved?: string; locked?: string } }) {
  ...
  rows.forEach((row, index) => { cumulativeCollections[index] = (cumulativeCollections[index - 1] || 0) + row.collection; });
