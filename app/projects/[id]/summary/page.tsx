...
export default async function TargetCostSummaryPage({ params }: { params: { id: string } }) {
  ...
  const hasCost = costTaxInclusive > 0;
  const preTaxMargin = revenue.taxInclusive && hasCost ? tax.profitBeforeIncomeTax / revenue.taxInclusive : 0;
  const netMargin = revenue.taxInclusive && hasCost ? tax.netProfit / revenue.taxInclusive : 0;
