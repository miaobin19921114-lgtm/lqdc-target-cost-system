...
const dictionaryItems: DictionarySeed[] = [
  ...
  { type: 'revenue_type', code: 'parking_sale', name: '车位销售收入', sortOrder: 30, remark: 'measurementMode=quantity;measurementUnit=个;pricingUnit=元/个' },
  { type: 'revenue_type', code: 'other_income', name: '其他收入', sortOrder: 40, remark: 'measurementMode=amount;measurementUnit=元;pricingUnit=元/项' },
...
const productPresets: ProductPresetSeed[] = [
  ...
  { key: 'apartment', name: '公寓', category: '商业', isSaleable: true, participateAllocation: true, defaultIncomeType: '商业销售收入', sortOrder: 100 },
  { key: 'office', name: '办公', category: '商业', isSaleable: true, participateAllocation: true, defaultIncomeType: '商业销售收入', sortOrder: 110 },
  { key: 'hotel', name: '酒店', category: '商业', isSaleable: false, participateAllocation: true, defaultIncomeType: '其他收入', sortOrder: 120 },
  { key: 'underground_parking', name: '地下车位', category: '车位', isSaleable: true, participateAllocation: true, defaultIncomeType: '车位销售收入', sortOrder: 130 },
  { key: 'civil_defense_parking', name: '人防车位', category: '车位', isSaleable: true, participateAllocation: true, defaultIncomeType: '车位销售收入', sortOrder: 140 },
  { key: 'non_civil_defense_parking', name: '非人防车位', category: '车位', isSaleable: true, participateAllocation: true, defaultIncomeType: '车位销售收入', sortOrder: 150 },
  { key: 'mechanical_parking', name: '立体车位', category: '车位', isSaleable: true, participateAllocation: true, defaultIncomeType: '车位销售收入', sortOrder: 160 },
...
const costSubjects: CostSubjectSeed[] = [
  ...
  { code: '01.01.05', name: '土地咨询/尽调费', parentCode: '01.01', level: 3, fullPath: '土地费 > 土地取得价款 > 土地咨询/尽调费', defaultMeasureBasis: '合同金额', defaultUnit: '元', defaultTaxRate: 0.06, defaultAllocationMethod: '按可售面积', sortOrder: 115 },
  ...
  { code: '03.01.02', name: '基坑支护', parentCode: '03.01', level: 3, fullPath: '建安工程费 > 土石方及基坑工程 > 基坑支护', defaultMeasureBasis: '地下建筑面积', defaultUnit: '㎡', defaultTaxRate: 0.09, defaultAllocationMethod: '按建筑面积', sortOrder: 312 },
